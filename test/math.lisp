...
(nst:def-test-group re*-tests ()
  ...
  (nst:def-test two-argument-multiplication (:equalp "1/4 - 1/12·√2 + 5/9·√3 - 5/27·√6")
    (%to-string (re* (make-rational-extension '(1/4 . 1) '(5/9 . 3))
                     (make-rational-extension '(1 . 1) '(-1/3 . 2)))))
